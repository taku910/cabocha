...
/*@SWIG:/usr/local/share/swig/1.3.33/ruby/rubyprimtypes.swg,23,%ruby_aux_method@*/
...
_wrap_new_Tree(int argc, VALUE *argv, VALUE self) {
  ...
  {
    try {
      result = (CaboCha::Tree *)new CaboCha::Tree();DATA_PTR(self) = result;
    }
    catch (char *e) {
      SWIG_exception (SWIG_RuntimeError, e); 
    }
...
_wrap_new_Parser__SWIG_0(int argc, VALUE *argv, VALUE self) {
  ...
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "char const *","CaboCha::Parser", 1, argv[0] ));
  }
  arg1 = reinterpret_cast< char * >(buf1);
  {
    try {
      result = (CaboCha::Parser *)new_CaboCha_Parser((char const *)arg1);DATA_PTR(self) = result;
    }
    catch (char *e) {
      SWIG_exception (SWIG_RuntimeError, e); 
    }
...
_wrap_new_Parser__SWIG_1(int argc, VALUE *argv, VALUE self) {
  ...
  {
    try {
      result = (CaboCha::Parser *)new_CaboCha_Parser();DATA_PTR(self) = result;
    }
    catch (char *e) {
      SWIG_exception (SWIG_RuntimeError, e); 
    }
...
SWIGEXPORT void Init_CaboCha(void) {
  ...
  rb_define_const(mCaboCha, "EUC_JP", SWIG_From_int(static_cast< int >(EUC_JP)));
  rb_define_const(mCaboCha, "CP932", SWIG_From_int(static_cast< int >(CP932)));
  rb_define_const(mCaboCha, "UTF8", SWIG_From_int(static_cast< int >(UTF8)));
  rb_define_const(mCaboCha, "ASCII", SWIG_From_int(static_cast< int >(ASCII)));
  rb_define_const(mCaboCha, "IPA", SWIG_From_int(static_cast< int >(IPA)));
  rb_define_const(mCaboCha, "JUMAN", SWIG_From_int(static_cast< int >(JUMAN)));
  rb_define_const(mCaboCha, "FORMAT_TREE", SWIG_From_int(static_cast< int >(FORMAT_TREE)));
  rb_define_const(mCaboCha, "FORMAT_LATTICE", SWIG_From_int(static_cast< int >(FORMAT_LATTICE)));
  rb_define_const(mCaboCha, "FORMAT_TREE_LATTICE", SWIG_From_int(static_cast< int >(FORMAT_TREE_LATTICE)));
  rb_define_const(mCaboCha, "FORMAT_XML", SWIG_From_int(static_cast< int >(FORMAT_XML)));
  rb_define_const(mCaboCha, "FORMAT_NONE", SWIG_From_int(static_cast< int >(FORMAT_NONE)));
  rb_define_const(mCaboCha, "INPUT_RAW_SENTENCE", SWIG_From_int(static_cast< int >(INPUT_RAW_SENTENCE)));
  rb_define_const(mCaboCha, "INPUT_POS", SWIG_From_int(static_cast< int >(INPUT_POS)));
  rb_define_const(mCaboCha, "INPUT_CHUNK", SWIG_From_int(static_cast< int >(INPUT_CHUNK)));
  rb_define_const(mCaboCha, "INPUT_SELECTION", SWIG_From_int(static_cast< int >(INPUT_SELECTION)));
  rb_define_const(mCaboCha, "INPUT_DEP", SWIG_From_int(static_cast< int >(INPUT_DEP)));
  rb_define_const(mCaboCha, "OUTPUT_RAW_SENTENCE", SWIG_From_int(static_cast< int >(OUTPUT_RAW_SENTENCE)));
  rb_define_const(mCaboCha, "OUTPUT_POS", SWIG_From_int(static_cast< int >(OUTPUT_POS)));
  rb_define_const(mCaboCha, "OUTPUT_CHUNK", SWIG_From_int(static_cast< int >(OUTPUT_CHUNK)));
  rb_define_const(mCaboCha, "OUTPUT_SELECTION", SWIG_From_int(static_cast< int >(OUTPUT_SELECTION)));
  rb_define_const(mCaboCha, "OUTPUT_DEP", SWIG_From_int(static_cast< int >(OUTPUT_DEP)));
  rb_define_const(mCaboCha, "TRAIN_NE", SWIG_From_int(static_cast< int >(TRAIN_NE)));
  rb_define_const(mCaboCha, "TRAIN_CHUNK", SWIG_From_int(static_cast< int >(TRAIN_CHUNK)));
  rb_define_const(mCaboCha, "TRAIN_DEP", SWIG_From_int(static_cast< int >(TRAIN_DEP)));
  
  cChunk.klass = rb_define_class_under(mCaboCha, "Chunk", rb_cObject);
  SWIG_TypeClientData(SWIGTYPE_p_cabocha_chunk_t, (void *) &cChunk);
  rb_undef_alloc_func(cChunk.klass);
  rb_define_method(cChunk.klass, "link", VALUEFUNC(_wrap_Chunk_link_get), -1);
  rb_define_method(cChunk.klass, "head_pos", VALUEFUNC(_wrap_Chunk_head_pos_get), -1);
  rb_define_method(cChunk.klass, "func_pos", VALUEFUNC(_wrap_Chunk_func_pos_get), -1);
  rb_define_method(cChunk.klass, "token_size", VALUEFUNC(_wrap_Chunk_token_size_get), -1);
  rb_define_method(cChunk.klass, "token_pos", VALUEFUNC(_wrap_Chunk_token_pos_get), -1);
  rb_define_method(cChunk.klass, "score", VALUEFUNC(_wrap_Chunk_score_get), -1);
  rb_define_method(cChunk.klass, "feature_list_size", VALUEFUNC(_wrap_Chunk_feature_list_size_get), -1);
  rb_define_method(cChunk.klass, "feature_list", VALUEFUNC(_wrap_Chunk_feature_list), -1);
  cChunk.mark = 0;
  cChunk.trackObjects = 0;
  
  cToken.klass = rb_define_class_under(mCaboCha, "Token", rb_cObject);
  SWIG_TypeClientData(SWIGTYPE_p_cabocha_token_t, (void *) &cToken);
  rb_undef_alloc_func(cToken.klass);
  rb_define_method(cToken.klass, "surface", VALUEFUNC(_wrap_Token_surface_get), -1);
  rb_define_method(cToken.klass, "normalized_surface", VALUEFUNC(_wrap_Token_normalized_surface_get), -1);
  rb_define_method(cToken.klass, "feature", VALUEFUNC(_wrap_Token_feature_get), -1);
  rb_define_method(cToken.klass, "feature_list_size", VALUEFUNC(_wrap_Token_feature_list_size_get), -1);
  rb_define_method(cToken.klass, "ne", VALUEFUNC(_wrap_Token_ne_get), -1);
  rb_define_method(cToken.klass, "chunk", VALUEFUNC(_wrap_Token_chunk_get), -1);
  rb_define_method(cToken.klass, "feature_list", VALUEFUNC(_wrap_Token_feature_list), -1);
  cToken.mark = 0;
  cToken.trackObjects = 0;
  
  cTree.klass = rb_define_class_under(mCaboCha, "Tree", rb_cObject);
  SWIG_TypeClientData(SWIGTYPE_p_CaboCha__Tree, (void *) &cTree);
  rb_define_alloc_func(cTree.klass, _wrap_Tree_allocate);
  rb_define_method(cTree.klass, "initialize", VALUEFUNC(_wrap_new_Tree), -1);
  rb_define_method(cTree.klass, "set_sentence", VALUEFUNC(_wrap_Tree_set_sentence), -1);
  rb_define_method(cTree.klass, "sentence", VALUEFUNC(_wrap_Tree_sentence), -1);
  rb_define_method(cTree.klass, "sentence_size", VALUEFUNC(_wrap_Tree_sentence_size), -1);
  rb_define_method(cTree.klass, "chunk", VALUEFUNC(_wrap_Tree_chunk), -1);
  rb_define_method(cTree.klass, "token", VALUEFUNC(_wrap_Tree_token), -1);
  rb_define_method(cTree.klass, "read", VALUEFUNC(_wrap_Tree_read), -1);
  rb_define_method(cTree.klass, "empty", VALUEFUNC(_wrap_Tree_empty), -1);
  rb_define_method(cTree.klass, "clear", VALUEFUNC(_wrap_Tree_clear), -1);
  rb_define_method(cTree.klass, "clear_chunk", VALUEFUNC(_wrap_Tree_clear_chunk), -1);
  rb_define_method(cTree.klass, "chunk_size", VALUEFUNC(_wrap_Tree_chunk_size), -1);
  rb_define_method(cTree.klass, "token_size", VALUEFUNC(_wrap_Tree_token_size), -1);
  rb_define_method(cTree.klass, "size", VALUEFUNC(_wrap_Tree_size), -1);
  rb_define_method(cTree.klass, "toString", VALUEFUNC(_wrap_Tree_toString), -1);
  rb_define_method(cTree.klass, "charset", VALUEFUNC(_wrap_Tree_charset), -1);
  rb_define_method(cTree.klass, "set_charset", VALUEFUNC(_wrap_Tree_set_charset), -1);
  rb_define_method(cTree.klass, "posset", VALUEFUNC(_wrap_Tree_posset), -1);
  rb_define_method(cTree.klass, "set_posset", VALUEFUNC(_wrap_Tree_set_posset), -1);
  rb_define_method(cTree.klass, "output_layer", VALUEFUNC(_wrap_Tree_output_layer), -1);
  rb_define_method(cTree.klass, "set_output_layer", VALUEFUNC(_wrap_Tree_set_output_layer), -1);
  cTree.mark = 0;
  cTree.destroy = (void (*)(void *)) free_CaboCha_Tree;
  cTree.trackObjects = 0;
  
  cParser.klass = rb_define_class_under(mCaboCha, "Parser", rb_cObject);
  SWIG_TypeClientData(SWIGTYPE_p_CaboCha__Parser, (void *) &cParser);
  ...
  rb_define_method(cParser.klass, "parseToString", VALUEFUNC(_wrap_Parser_parseToString), -1);
  rb_define_method(cParser.klass, "parse", VALUEFUNC(_wrap_Parser_parse), -1);
  rb_define_method(cParser.klass, "what", VALUEFUNC(_wrap_Parser_what), -1);
  rb_define_singleton_method(cParser.klass, "version", VALUEFUNC(_wrap_Parser_version), -1);
  cParser.mark = 0;
  cParser.destroy = (void (*)(void *)) free_CaboCha_Parser;
  cParser.trackObjects = 0;
  rb_define_const(mCaboCha, "VERSION", SWIG_FromCharPtr("0.60pre1"));
}
